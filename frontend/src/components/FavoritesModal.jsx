...
export default function FavoritesModal({ isOpen, onClose, favorites, onOpen, onDelete, loading }) {
          ...
          <div className="flex-1 overflow-y-auto p-6">
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-dark-400">No favorites saved yet</p>
                <p className="text-dark-500 text-sm mt-1">Tap the heart on any wisdom card to save it here</p>
              </div>
            ) : (
                ...
                {favorites.map((entry, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button
                        onClick={() => onDelete(entry.wisdom_id || entry.id)}
